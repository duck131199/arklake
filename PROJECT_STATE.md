...
- Download Invoice files are `api/invoice-pdf.ts`, `api/invoice-pdf-core.ts`, `api/arklake-logo.js`, `src/App.tsx`, `tests/invoice-pdf.test.mjs`, `package.json`, `package-lock.json`, and this ledger. Active and Expired PDFs were generated from real localhost invoice data and visually rendered successfully.
